...
def training(nfiltbank, orderLPC):
    ...
    plt.grid()
    plt.legend((s1, s2, c1, c2), ('Signal 1','Signal 2','Signal 1 centroids', 'Signal 2 centroids'), scatterpoints = 1, loc = 'upper left')    
    plt.show()
